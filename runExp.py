...
def sampler(n: int) -> NDArray:
    ...
    noise: NDArray = stats.lomax.rvs(noiseShape, size = n, random_state = rngData) - stats.lomax.rvs(noiseShape, size = n, random_state = rngData)
...
if __name__ == "__main__":
    ...
    pipeline("LR_SAA", str(uuid4()), lr, sampler, evaluator, sampleSizeList, kList, BList, k12List, B12List, numReplicates)