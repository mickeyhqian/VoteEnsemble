...
if __name__ == "__main__":
    ...
    def sampler(repIdx: int) -> NDArray:
    ...
    def inference(learningResult: RegressionNN, sample: NDArray) -> torch.Tensor:
        return baseNN.inference(learningResult, sample, device = evalDevice)
    ...
    for dirName in dirList:
        ...
        testSample = sampler(index)
        YTruth = torch.Tensor(testSample[:, :1])
        ...
        for modelFile in modelFiles:
            ...
            prediction = inference(model, testSample)
