...
if __name__ == "__main__":
    ...
    tic = time.time()
    SAA_list, bagging_alg3_list, bagging_alg4_list = comparison_twoPhase(k_list, B12_list, epsilon, tolerance, number_of_iterations,sample_number, rng_sample, rng_alg, sample_args)
